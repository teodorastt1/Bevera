...
namespace Bevera.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var draftPurchaseOrders = await _db.PurchaseOrders
    .CountAsync(x => x.Status == PurchaseOrderStates.Draft);

            var submittedPurchaseOrders = await _db.PurchaseOrders
                .CountAsync(x =>
            ...
            var receivedPurchaseOrders = await _db.PurchaseOrders
                .CountAsync(x => x.Status == PurchaseOrderStates.Paid);
