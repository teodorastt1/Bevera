namespace Bevera.Models.ViewModels.Supply
{
    ...
    public class PurchaseOrderItemRowVm
    {
        ...
        public int CasesCount => UnitsPerCase > 0 ? Quantity / UnitsPerCase : Quantity;
        public string DisplayQuantity => UnitsPerCase > 0 ? $"{CasesCount} каш. ({Quantity} бр.)" : $"{Quantity} бр.";
    }
}